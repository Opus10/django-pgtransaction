# -*- coding: utf-8 -*-
#
# django-pgtransaction documentation build configuration file, created by
...
version = pgtransaction.__version__
...
htmlhelp_basename = "django-pgtransactiondoc"
...
latex_documents = [
    (
        master_doc,
        "django-pgtransaction.tex",
        "django-pgtransaction Documentation",
        "Opus 10",
        "manual",
    )
]
